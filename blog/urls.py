...
urlpatterns = [
    ...
    path(
        "australasia/", views.AusPostList.as_view(), name="australasia_posts"
        ),
    ...
    path(
        "post/<slug:slug>/cancel-edit/",
        views.cancel_edit_post, name="cancel_post_edit"
        ),
    ...
    path(
        "post/<slug:slug>/cancel_edit_comment/",
        views.cancel_edit_comment, name="cancel_comment"
        ),
